...
public class ProjectController {
    ...
    @GetMapping
    public ResponseEntity<GenericRestResponse<?>> fetchAllProjects() {
    ...
    public ResponseEntity<GenericRestResponse<?>> fetchAllAvailableEmployeesForProject(@PathVariable(value = "projectId") Long projectId){
